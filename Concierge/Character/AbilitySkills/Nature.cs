// <copyright file="Nature.cs" company="Thomas Beckett">
...
namespace Concierge.Character.AbilitySkills
{
    ...
    public sealed class Nature : Skill
    {
        private int bonus;

        public Nature(bool proficiency = false, bool expertise = false, StatusChecks checkOverride = StatusChecks.Auto)
        {
        ...
        {
            return new Nature(this.Proficiency, this.Expertise, this.CheckOverride);
        }
    }
}