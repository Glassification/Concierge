...
namespace Concierge.Character.AbilitySkills
{
    ...
    public sealed class History : Skill
    {
        private int bonus;

        public History(bool proficiency = false, bool expertise = false, StatusChecks checkOverride = StatusChecks.Auto)
        {
        ...
        {
            return new History(this.Proficiency, this.Expertise, this.CheckOverride);
        }
    }
}