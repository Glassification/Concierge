// <copyright file="Perception.cs" company="Thomas Beckett">
...
namespace Concierge.Character.AbilitySkills
{
    ...
    public sealed class Perception : Skill
    {
        private int bonus;

        public Perception(bool proficiency = false, bool expertise = false, StatusChecks checkOverride = StatusChecks.None)
        {
        ...
        public override int Bonus
        {
            get
            {
                ...
                this.bonus += Constants.CalculateBonus(Program.CcsFile.Character.Characteristic.Attributes.Wisdom);
        ...
        {
            return new Perception(this.Proficiency, this.Expertise, this.CheckOverride);
        }
    }
}