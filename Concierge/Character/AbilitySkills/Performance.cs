// <copyright file="Performance.cs" company="Thomas Beckett">
...
namespace Concierge.Character.AbilitySkills
{
    ...
    public sealed class Performance : Skill
    {
        private int bonus;

        public Performance(bool proficiency = false, bool expertise = false, StatusChecks checkOverride = StatusChecks.None)
        {
        ...
        {
            return new Performance(this.Proficiency, this.Expertise, this.CheckOverride);
        }
    }
}