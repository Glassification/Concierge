// <copyright file="Survival.cs" company="Thomas Beckett">
...
namespace Concierge.Character.AbilitySkills
{
    ...
    public sealed class Survival : Skill
    {
        private int bonus;

        public Survival(bool proficiency = false, bool expertise = false, StatusChecks checkOverride = StatusChecks.None)
        {
        ...
        {
            return new Survival(this.Proficiency, this.Expertise, this.CheckOverride);
        }
    }
}