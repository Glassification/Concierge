// <copyright file="Medicine.cs" company="Thomas Beckett">
...
namespace Concierge.Character.AbilitySkills
{
    ...
    public sealed class Medicine : Skill
    {
        private int bonus;

        public Medicine(bool proficiency = false, bool expertise = false, StatusChecks checkOverride = StatusChecks.None)
        {
        ...
        {
            return new Medicine(this.Proficiency, this.Expertise, this.CheckOverride);
        }
    }
}