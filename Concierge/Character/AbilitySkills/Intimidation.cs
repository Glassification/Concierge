// <copyright file="Intimidation.cs" company="Thomas Beckett">
...
namespace Concierge.Character.AbilitySkills
{
    ...
    public sealed class Intimidation : Skill
    {
        private int bonus;

        public Intimidation(bool proficiency = false, bool expertise = false, StatusChecks checkOverride = StatusChecks.None)
        {
        ...
        public override int Bonus
        {
            get
            {
                ...
                this.bonus += Constants.CalculateBonus(Program.CcsFile.Character.Characteristic.Attributes.Charisma);
        ...
        {
            return new Intimidation(this.Proficiency, this.Expertise, this.CheckOverride);
        }
    }
}