// <copyright file="Acrobatics.cs" company="Thomas Beckett">
...
namespace Concierge.Character.AbilitySkills.SkillTypes
{
    ...
    public sealed class Acrobatics : Skills
    {
        private int bonus;

        public Acrobatics(bool proficiency = false, bool expertise = false, StatusChecks checkOverride = StatusChecks.None)
        {
        ...
        public override int Bonus
        {
            get
            {
                ...
                this.bonus += Constants.CalculateBonus(Program.CcsFile.Character.Attributes.Dexterity);
        ...
        {
            return new Acrobatics(this.Proficiency, this.Expertise, this.CheckOverride);
        }
    }
}