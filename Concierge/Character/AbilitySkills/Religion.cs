// <copyright file="Religion.cs" company="Thomas Beckett">
...
namespace Concierge.Character.AbilitySkills
{
    ...
    public sealed class Religion : Skill
    {
        private int bonus;

        public Religion(bool proficiency = false, bool expertise = false, StatusChecks checkOverride = StatusChecks.None)
        {
        ...
        {
            return new Religion(this.Proficiency, this.Expertise, this.CheckOverride);
        }
    }
}