// <copyright file="Deception.cs" company="Thomas Beckett">
...
namespace Concierge.Character.AbilitySkills
{
    ...
    public sealed class Deception : Skill
    {
        private int bonus;
        ...
        {
            return new Deception(this.Proficiency, this.Expertise, this.CheckOverride);
        }
    }
}