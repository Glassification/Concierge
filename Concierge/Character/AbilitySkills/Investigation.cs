// <copyright file="Investigation.cs" company="Thomas Beckett">
...
namespace Concierge.Character.AbilitySkills
{
    ...
    public sealed class Investigation : Skill
    {
        private int bonus;

        public Investigation(bool proficiency = false, bool expertise = false, StatusChecks checkOverride = StatusChecks.None)
        {
        ...
        public override int Bonus
        {
            get
            {
                ...
                this.bonus += Constants.Bonus(Program.CcsFile.Character.Characteristic.Attributes.Intelligence);
        ...
        {
            return new Investigation(this.Proficiency, this.Expertise, this.CheckOverride);
        }
    }
}