...
namespace Concierge.Character.AbilitySkills
{
    ...
    public sealed class Arcana : Skill
    {
        private int bonus;

        public Arcana(bool proficiency = false, bool expertise = false, StatusChecks checkOverride = StatusChecks.None)
        {
        ...
        {
            return new Arcana(this.Proficiency, this.Expertise, this.CheckOverride);
        }
    }
}